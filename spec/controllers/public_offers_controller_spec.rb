...
describe PublicOffersController do
  ...
  # PublicOffersController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all public_offers as @public_offers" do
      offer = Offer.create! valid_attributes
      get :index, {}, valid_session
      assigns(:public_offers).should eq([offer])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested offer" do
        offer = Offer.create! valid_attributes
        # Assuming there are no other public_offers in the database, this
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the public_offers list" do
      offer = Offer.create! valid_attributes
      delete :destroy, {:id => offer.to_param}, valid_session
